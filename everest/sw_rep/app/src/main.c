...
static void vSetupTask(void *pvParameters __attribute((unused)))
{
	BaseType_t xReturn;
...
int main( void )
{
	...
	/* create setup task */
	BaseType_t xReturn;
	xReturn = xTaskCreate(vSetupTask, SETUP_NAME, SETUP_STACK_SIZE, NULL, SETUP_TASK_PRIORITY, NULL);
	if (xReturn != pdPASS)
	{
	    printf("main(): Could not create setup task, error: %d\n", (int)xReturn);
	}
